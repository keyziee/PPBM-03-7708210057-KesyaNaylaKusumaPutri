...
public class CostumArrayAdapterLATT extends ArrayAdapter<MyListView>
{

    public CostumArrayAdapterLATT(@NonNull Context context, int resource, @NonNull ArrayList<MyListView> myListViews) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        {
            listitemView = LayoutInflater.from(getContext()).inflate(R.layout.costum_listlatt, parent, false);
