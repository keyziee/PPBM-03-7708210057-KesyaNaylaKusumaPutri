...
public class CostumArrayAdapterOHAOD extends ArrayAdapter<MyListView>
{

    public CostumArrayAdapterOHAOD(@NonNull Context context, int resource, @NonNull ArrayList<MyListView> myListViews) {
